import { render, fireEvent, act, findByLabelText } from "@testing-library/react";
...
test('check register fail', async () => {
  ...
  await act(async () => {    
    ...
    expect(await findByLabelText(container,"There's been an error in the register proccess.")).toBeInTheDocument();
  });
